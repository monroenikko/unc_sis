...
class CreateGrade11SecondSemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('grade11__second__sems', function (Blueprint $table) {
            #region$table->increments('id');
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('grade11__second__sems');
    }
}
