...
class CreateGradeSheetSecondsemsecondsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('grade_sheet_secondsemseconds', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('grade_sheet_secondsemseconds');
    }
}
