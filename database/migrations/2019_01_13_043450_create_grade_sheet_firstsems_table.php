...
class CreateGradeSheetFirstsemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('grade_sheet_firstsems', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('grade_sheet_firstsems');
    }
}
